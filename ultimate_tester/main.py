...
def cleanup() -> None:
    ...
    """
    os.system("rm -rf ./ultimate_tester/__pycache__")
    os.system("rm -rf ./ultimate_tester/testcase/__pycache__")
...
def run() -> None:
    ...
    run_test("PUT /put/long.txt", test_big_put)
    run_test("POST /put/long.txt", test_big_post)
